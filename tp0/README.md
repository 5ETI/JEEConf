...
You should see messages similar to the following:
    ...
    INFO  [tp0.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [tp0.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
